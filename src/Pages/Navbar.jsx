  ...
  return (
    ...
    md:opacity-100 md:translate-x-0 md:flex list-none`}
      >
        ...
        >
         {logText}
          <MdOutlineLogin className='inline-block text-black cursor-pointer hover:text-red-300 ease-out delay-100 ' size={17} onClick={onLogin} />
        </button>
      </div>
